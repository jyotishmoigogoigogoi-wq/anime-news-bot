...
# Groq AI Config (Render Compatible)
...
def ai_cmd(message):
    ...
    # Chat Response (Groq Llama 3 - Free & Fast)
    ...
    try:
        ...
        response = openai_client.chat.completions.create(
            ...
            messages=[
                {"role": "system", "content": f"You are a professional AI Assistant for the Anime News bot. Respond in {lang_name}. Keep it friendly."},
